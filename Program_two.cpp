...
int main() {
    ...
    Estudiante* estudiantes[MAX_ESTUDIANTES]; // Array de punteros a estudiantes

    // Ingresar información de cada estudiante
    for (int i = 0; i < n; ++i) {
        estudiantes[i] = new Estudiante; // Reservar memoria para un nuevo estudiante
    ...
    // Liberar la memoria reservada para cada estudiante
    for (int i = 0; i < n; ++i) {
